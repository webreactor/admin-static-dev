...
gulp.task('data', function () {
    return gulp.src(config.build.src.data)
        .pipe(gulpNewer(config.build.dest.data))
        .pipe(gulp.dest(config.build.dest.data))
        .pipe(browserSync.stream());
});

gulp.task('build', ['img', 'fonts', 'data'], function () {
